...
class $CategoriesTable extends Categories
  ...
  late final GeneratedColumn<int> iconCode = GeneratedColumn<int>(
      ...
      type: DriftSqlType.int, requiredDuringInsert: true);
  @override
  List<GeneratedColumn> get $columns => [id, category, colorValue, iconCode];
  @override
...
class Category extends DataClass implements Insertable<Category> {
  ...
  Category copyWith(
          {int? id, String? category, int? colorValue, int? iconCode}) =>
      Category(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, category, colorValue, iconCode);
  @override
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  List<GeneratedColumn> get $columns =>
      [id, title, description, dueDate, categoryId, priority, isCompleted];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
